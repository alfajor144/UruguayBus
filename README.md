...
### In Microsoft SQL Server Management Studio 18 create a data base called "uybus"
### Run "uybus.sql"
### Run "datosP.sql"
### Open "SolutionUyBus.sln"
### Rigth click in the solution, properties, select multy project option
### Select start in "API_SOAP", "APIREST", "WebApp", "Terminal".
### Start the project
